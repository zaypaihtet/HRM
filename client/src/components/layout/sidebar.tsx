...
import { Users, BarChart3, Clock, DollarSign, FileCheck, Calendar, Smartphone, LogOut, MapPin, FileText, UserPlus, Settings, Calculator, Cog } from "lucide-react";
...
const navigation = [
  ...
  { name: "Working Hours", href: "/working-hours", icon: Settings },
